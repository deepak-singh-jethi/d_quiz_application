...
function ShowEvaluation() {
  ...
  return (
    <div className="min-h-screen max-w-fit mx-6 sm:mx-10 eval overflow-hidden ">
      <div className="w-full overflow-x-auto " style={{ maxHeight: "400px" }}>
        <div className="relative">
          <table className=" bg-white border border-gray-300 tablez">
            ...
            <tbody className="max-h-400 overflow-scroll  text-stone-500">
              {qusAns.map((qusAns, index) => (
                <tr key={qusAns.question} className="hover:bg-gray-100">
                  ...
                  />
                  <td
                    className="sm:table-cell py-1 px-1 sm:px-4 border-2"
